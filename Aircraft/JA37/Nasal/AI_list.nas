...
var AImodel = {
    ...
    update: func(n = nil) {
        ...
        foreach(var n ; props.globals.getNode("ai/models", 1).getChildren())
        {
            ...
            if((var valid = n.getNode("valid")) == nil or (!valid.getValue()) or n.getNode("missile") == nil or n.getNode("missile").getValue() != 1 or n.getNode("callsign") == nil or n.getNode("callsign").getValue() != "es")
            {
                continue;
            }
