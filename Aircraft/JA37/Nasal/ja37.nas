...
var outgoingBridge = emesary_mp_bridge.OutgoingMPBridge.new("JA37mp",routedNotifications, 19, "", bridgedTransmitter);
...
var f14_aircraft_notification = notifications.PropertySyncNotification.new("JA37"~getprop("/sim/multiplay/callsign"));
