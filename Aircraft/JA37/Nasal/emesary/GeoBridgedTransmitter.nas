...
var geooutgoingBridge = emesary_mp_bridge.OutgoingMPBridge.new("JA37mp.geo",geoRoutedNotifications, 18, "", geoBridgedTransmitter);
...
var hitoutgoingBridge = emesary_mp_bridge.OutgoingMPBridge.new("JA37mp.hit",hitRoutedNotifications, 19, "", hitBridgedTransmitter);
...
var objectoutgoingBridge = emesary_mp_bridge.OutgoingMPBridge.new("JA37mp.object",objectRoutedNotifications, 17, "", objectBridgedTransmitter);
