...
var crash_start = func {
	...
	if (getprop("sim/ja37/supported/crash-system") == 1) {
		crashCode = CrashAndStress.new([0,1,2], {"weightLbs":33477.19, "maxG": 12, "minG": -5}, ["controls/gear1", "controls/gear2", "controls/flight/aileron", "controls/flight/elevator", "consumables/fuel/wing-tanks"]);
		crashCode.start();
	}
}
