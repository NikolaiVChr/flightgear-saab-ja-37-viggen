...
var crash_start = func {
    ...
    if (variant.JA) {
        ...
        crashCode = CrashAndStress.new([0,1,2], {"weightLbs": 33000, "maxG": 30, "minG": -15}, ["controls/gear1", "controls/gear2", "controls/flight/left-elevon", "controls/flight/right-elevon"]);
    } else {
